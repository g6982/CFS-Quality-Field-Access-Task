...
{
    "name": "Budget for Job Contracting and Construction Projects Enterprice",
    "currency": "EUR",
    "version": "4.2.1",
    "license": "Other proprietary",
    "price": 99.0,
    "depends": ["cfs_autoexec", "odoo_job_costing_management", "account_budget"],
    "author": "Probuse Consulting Service Pvt. Ltd.",
    "website": "www.probuse.com",
    "live_test_url": "https://probuseappdemo.com/probuse_apps/job_costing_budget_contracting_enterprice/585",  #'https://youtu.be/B74GCfiRGto', # 'https://youtu.be/vrQdBfQ1yUQ',
